...
int main() {
	...
	for (;;) {
		...
		G.displayNodeInfo(3, 1);	// display path from node 3 to 1 to cout
		G.displayNodeInfo(1, 2);
		G.displayNodeInfo(1, 3);
		G.displayNodeInfo(1, 4);
		G.displayNodeInfo(1, 5);
		G.displayNodeInfo(2, 3);
		G.displayNodeInfo(2, 5);
		G.displayNodeInfo(4, 5);
	}
