...
#include <iostream>
using namespace std;
template <class Object> struct DListNode {
	// a list node  
	Object item;
	DListNode *prev;
	DListNode *next;
};
template <class Object> class DList {
...
public:   DList();
		  ...
		  int size() const;
		  // retrieves # list nodes;  
		  void clear();
		  // clean up all list entries.  
...
protected:   DListNode<Object> *header;                        // header  
